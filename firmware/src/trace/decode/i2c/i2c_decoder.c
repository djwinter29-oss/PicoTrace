 ...
 * events through one caller-provided event sink.
 */
...
static i2c_decoder_result_t i2c_decoder_process_buffer_with_sink(
...
i2c_decoder_result_t i2c_decoder_process_buffer(
    ...
    return i2c_decoder_process_buffer_with_sink(
        state,
        raw_words,
        raw_word_count,
        event_sink,
